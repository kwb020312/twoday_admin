        ...
        <div className="bg-white/95 rounded-3xl shadow-2xl p-8 border border-main">
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-6">
              ...
              {/* 로그인 버튼 */}
              <button className="w-full bg-main text-white py-3 px-4 rounded-xl font-medium hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-main focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center group">
